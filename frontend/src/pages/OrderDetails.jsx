      ...
      <div className="pt-18 container mx-auto px-4 md:px-8 max-w-4xl">
        <div className="card bg-base-100 shadow-xl text-center py-12">
          <div className="card-body items-center">
            ...
            <p className="mb-6 text-base-content/70">The order you're looking for doesn't exist or has been removed.</p>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-5xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
            ...
            <div className="mt-4 md:mt-0">
              <div className={`badge badge-lg ${getStatusBadge()}`}>
                {getStatusText()}
              </div>
            </div>
          </div>
                ...
                <div className="card-body p-5">
                  ...
                  <div className="space-y-4">
                    {order.orderItems.map((item, index) => (
                      <div key={index} className="flex flex-col sm:flex-row sm:items-center border-b border-base-200 pb-4 last:border-0 last:pb-0">
                        <div className="flex-1 mb-2 sm:mb-0">
                          <h3 className="font-semibold">{item.name}</h3>
                          <div className="flex justify-between sm:justify-start mt-1">
                            <span className="text-sm text-base-content/70">Qty: {item.quantity}</span>
                            <span className="text-sm text-base-content/70 sm:ml-4">Price: ${item.price.toFixed(2)}</span>
                          </div>
                        </div>
                  ...
                  <div className="space-y-2">
                    {order.isDelivered ? (
                      <div className="alert alert-success">
                        ...
                        <div>
                          ...
                          <div className="text-xs">Your order was delivered on {formatDate(order.deliveredAt)}</div>
                        </div>
                      </div>
                    ) : (
                    ...
                    <div className="my-4 py-2">
                      <ul className="steps steps-vertical">
                        ...
                        <li className={`step ${order.isPaid ? 'step-primary' : ''}`}>Payment Confirmed</li>
                        <li className={`step ${order.isPaid && !order.isDelivered ? 'step-primary' : ''}`}>Processing</li>
                        <li className={`step ${order.isDelivered ? 'step-primary' : ''}`}>Delivered</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="card bg-base-100 shadow-lg border border-base-300">
                <div className="card-body p-5">
                  ...
                  <p className="text-base-content/70">{order.shippingPrice > 0 ? 'Standard Shipping' : 'Free Shipping'}</p>
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {order.isPaid && order.paymentResult ? (
                      <div>
                        ...
                        <p className="text-sm">Transaction ID: <span className="font-mono">{order.paymentResult.id}</span></p>
