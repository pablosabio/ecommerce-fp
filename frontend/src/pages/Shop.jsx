  ...
  return (
    <div className="min-h-screen pt-24">
      ...
      <div className="flex flex-col lg:flex-row">
        <div
          className={`w-full lg:w-64 px-4 lg:pl-8 lg:pr-4 ${isMobileFilterOpen ? 'block' : 'hidden'} lg:block lg:flex-shrink-0`}
        >
                  ...
                  >
                    <div className="card-body">
                          ...
                          {category === 'audio' && (
                            ...
                            >
                              <path
                                ...
                                strokeLinejoin="round"
                                strokeWidth="2"
                                d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15.536a5 5 0 001.414-3.536 5 5 0 015-5c1.325 0 2.532.526 3.414 1.464m-3.414 3.536a1 1 0 00-1.414 1.414m3.828-3.828a1 1 0 00-1.414 1.414"
                              />
                            </svg>
                          )}
                          {category === 'computers' && (
                      ...
                      <div className="card-actions justify-center mt-2">
                        <span className="text-orange-500 font-medium group-hover:underline transition-all">
                          Browse Collection
                        </span>
                      </div>
                    </div>
