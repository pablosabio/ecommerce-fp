  ...
  <div className="container mx-auto p-4 md:p-8 mt-16 md:mt-20">
    ...
    <div className="text-sm breadcrumbs mb-4 p-2 bg-base-200 rounded-md inline-block">
      <ul>
        ...
        <li><Link to={`/category/${product.category}`} className="hover:text-orange-500 transition-colors">{product.category || "Products"}</Link></li>
    ...
    {product.images && product.images.map((image, index) => (
      ...
      >
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <button onClick={prevImage} className="btn btn-circle btn-sm hover:bg-orange-500 hover:text-white border-none shadow-md transition-all">❮</button>
          <button onClick={nextImage} className="btn btn-circle btn-sm hover:bg-orange-500 hover:text-white border-none shadow-md transition-all">❯</button>
        </div>
      ...
      <div className="card-body p-4 lg:p-6 lg:w-3/5 overflow-y-auto">
        <h2 className="card-title text-2xl lg:text-3xl mb-2 pb-2 border-b border-base-200">{product.name}</h2>
