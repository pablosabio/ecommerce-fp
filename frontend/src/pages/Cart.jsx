          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body items-center text-center py-16">
              ...
              <p className="text-base-content/70 max-w-md mx-auto mb-8">
                Looks like you haven't added any products to your cart yet. Explore our products and
            ...
            <div className="lg:col-span-8">
              ...
              <div className="card bg-base-100 shadow-lg overflow-hidden border border-base-300">
                ...
                {cartItems.map((item, index) => (
                  <div
                    key={item.id}
                    className={`flex p-6 ${index !== cartItems.length - 1 ? 'border-b border-base-200' : ''}`}
                  >
                    {/* Item Image */}
                    ...
                    <div className="flex-grow">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                        ...
                        <p className="font-semibold md:text-right mb-3 md:mb-0">
