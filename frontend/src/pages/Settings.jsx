              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1">
                  <form onSubmit={handleImageUpload} className="space-y-4">
                    ...
                    {uploadStatus && (
                      <div
                        className={`mt-2 text-sm ${uploadStatus.includes('Error') ? 'text-error' : 'text-success'}`}
                      >
                        {uploadStatus}
                      </div>
                    )}
          ...
          <div className="card bg-base-100 shadow-xl border border-base-200">
            <div className="card-body">
              ...
              <form onSubmit={handleChangePasswordSubmit} className="space-y-4">
                ...
                {passwordStatus && (
                  <div
                    className={`mt-2 text-sm ${passwordStatus.includes('Error') ? 'text-error' : 'text-success'} bg-base-200 p-3 rounded-lg`}
                  >
                    {passwordStatus}
                  </div>
                )}
          ...
          <div className="card bg-base-100 shadow-xl border border-base-200">
            <div className="card-body">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-base-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-base-content/70">
                      Receive emails for order updates and shipping information
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-base-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-base-content/70">
                      Receive news about new products and features
                    </p>
                  </div>
              ...
              <div className="card-actions mt-4">
                <button className="btn bg-orange-500 border-b-4 border-orange-700 text-white font-medium transition-all duration-300 hover:bg-orange-600 hover:translate-y-[1px] hover:border-b-2">
                  Save Preferences
                </button>
              </div>
            </div>
