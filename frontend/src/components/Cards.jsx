...
export const ProductCard = ({ id, name, images, price, rating, reviewCount, category }) => {
    ...
    <div className="card bg-base-100 shadow-sm hover:shadow-md transition-shadow duration-200 rounded-lg overflow-hidden">
      ...
      <div className="card-body p-3 pt-2">
        <Link to={`/product/${id}`} className="hover:text-primary">
          <h3 className="text-base md:text-lg font-bold text-base-content line-clamp-2 min-h-[3rem]">
            {name}
          </h3>
        </Link>
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <span className="transition-transform duration-300 transform group-hover:translate-x-3 inline-block">
              Add to Cart
            </span>
...
export const ProductsGrid = ({ title = 'All Products', productList = [], category = null }) => {
