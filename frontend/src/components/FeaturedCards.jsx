...
export default function FeatureCards() {
  const features = [
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dnhduqv8j/image/upload/v1747321945/boy_with_laptop_image_emwmrz.png", 
    ...
    <div className="flex justify-center py-8">
      <div className="w-5/6 grid grid-cols-1 md:grid-cols-3 gap-10">
        {features.map((feature) => (
          <div key={feature.id} className="relative overflow-hidden rounded-lg shadow-lg h-150">
            {/* Background Image */}
            <img 
              src={feature.image} 
              alt={feature.title} 
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              ...
              <Link 
                to={feature.link} 
                className="inline-flex items-center bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded"
              >
                Buy now
