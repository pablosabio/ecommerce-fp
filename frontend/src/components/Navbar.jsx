      ...
      <div className="navbar bg-base-100 shadow-md fixed top-0 z-50 px-3 md:px-5 transition-all duration-300">
          ...
          <div className="lg:hidden mr-2">
            ...
            <div
              className={`menu menu-sm dropdown-content mt-3 p-4 shadow-lg bg-base-100 rounded-box w-60 absolute top-full left-0 transition-all duration-300 origin-top-left ${
                isMenuOpen ? 'scale-100 opacity-100 z-50' : 'scale-95 opacity-0 -z-10'
              }`}
            >
          ...
          <ul className="menu menu-horizontal px-1 text-lg font-medium">
            ...
            <li>
              <details className="dropdown">
                <summary className="hover:bg-base-200 transition-all duration-200">
                  Categories
                </summary>
        ...
        <div className="navbar-end gap-2 md:gap-3">
          ...
          <div className="dropdown dropdown-end">
            <button
              tabIndex={0}
              className="btn btn-ghost btn-circle tooltip tooltip-bottom relative group"
              data-tip="Cart"
            ...
            >
              <div className="indicator flex items-center justify-center rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 group-hover:text-orange-500 transition-colors duration-200"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                {cartItems.length > 0 && (
                  <span
                    className={`badge badge-sm indicator-item ${BRAND_BG} text-white border-none animate-bounce-once`}
                  >
            ...
            <div
              tabIndex={0}
              className="card dropdown-content z-[1] mt-3 shadow-lg bg-base-100 rounded-box w-80 animate-fadeIn"
            >
                  ...
                  {cartItems.length === 0 ? (
                    ...
                    <>
                      {cartItems.slice(0, 3).map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center gap-3 py-3 border-b hover:bg-base-100/50 transition-colors rounded-lg p-2"
                        >
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-64 p-3 shadow-lg animate-fadeIn"
            >
              {isAuthenticated ? (
                <>
