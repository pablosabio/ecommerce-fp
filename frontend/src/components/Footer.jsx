          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-base-content/70 mb-4">
                Your trusted destination for premium tech products at competitive prices. Fast
                shipping, exceptional service.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/category/audio" className="hover:text-orange-500 transition-colors">
                    Audio
                  </Link>
                </li>
                <li>
